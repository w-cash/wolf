...
mod pool_backend_listener;
mod pool_backend_transport;
pub mod protocol;
pub mod rpc;
pub mod zip301;
...
pub use coordinator::{
    ...
    NativeWinnerBlock, NativeWinnerMaterial, PoolWinnerReconciliationError,
    WcashIncomingViewingKey, WinnerOutboxStatus,
};
