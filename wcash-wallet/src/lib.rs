...
pub use wallet::{
    ...
    open_wallet_database, pending_signed_transactions, propose_coinbase_shielding_offline,
    propose_transfer_offline, stored_signed_transaction, synchronize_wallet,
    synchronize_wallet_cancellable, verify_wallet_seed, wallet_balance,
    wallet_balance_with_confirmations, AccountBalanceSummary, CalculatedTransaction,
    ConfirmedTransaction, ConfirmedTransactionDirection, ConfirmedTransactionHistory,
    ConfirmedTransactionKind, InitializedWallet, PendingSignedTransactionPage, SignedTransaction,
    StagedTransactionProposal, StoredSignedTransaction, TransferRecipient, WalletBalanceSummary,
    WalletDatabase, WalletInfo, WalletServiceError, WalletSyncCancellation,
