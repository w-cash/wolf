...
impl TxVersion {
    ...
    pub fn suggested_for_branch(consensus_branch_id: BranchId) -> Self {
        match consensus_branch_id {
            ...
            | BranchId::WcashRegtestV1 => TxVersion::V6,
    ...
    pub fn valid_in_branch(&self, consensus_branch_id: BranchId) -> bool {
        ...
        match self {
            ...
            TxVersion::V4 => match consensus_branch_id {
                ...
                Nu6_3 => true,
                WcashTestnetV1 | WcashTestnetV3 | WcashMainnetV1 | WcashRegtestV1 => false,
                #[cfg(zcash_unstable = "nu7")]
                Nu7 => false, // ZIP 2003
            },
            ...
            TxVersion::V6 => match consensus_branch_id {
                ...
                | WcashTestnetV3
                | WcashMainnetV1
                | WcashRegtestV1 => true, // Ironwood / NU6.3 semantics
                #[cfg(zcash_unstable = "nu7")]
...
pub mod testing {
    ...
    pub fn arb_tx_version(branch_id: BranchId) -> impl Strategy<Value = TxVersion> {
        match branch_id {
            ...
            BranchId::WcashTestnetV1 | BranchId::WcashTestnetV3 | BranchId::WcashMainnetV1 | BranchId::WcashRegtestV1 => {
